...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.ibdbcompany.ibdb.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.ibdbcompany.ibdb.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.ibdbcompany.ibdb.domain.Role.class.getName());
            createCache(cm, com.ibdbcompany.ibdb.domain.Role.class.getName() + ".users");
