...
import com.ibdbcompany.ibdb.service.dto.PasswordChangeDTO;
import com.ibdbcompany.ibdb.service.dto.UserDTO;
import com.ibdbcompany.ibdb.web.rest.errors.*;
...
public class AccountResource {
    ...
    public UserDTO getAccount() {
        return userService.findUserWithRoles()
            .map(UserDTO::new)
    ...
    public void saveAccount(@Valid @RequestBody UserDTO userDTO) {
        ...
        userService.updateUser(userDTO.getFirstName(), userDTO.getLastName(), userDTO.getEmail(),
            userDTO.getLangKey(), userDTO.getImageUrl(), user.get().getImageModel());
    }
