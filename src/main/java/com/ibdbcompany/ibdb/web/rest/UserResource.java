...
import com.ibdbcompany.ibdb.service.MailService;
...
import com.ibdbcompany.ibdb.web.rest.errors.EmailAlreadyUsedException;
import com.ibdbcompany.ibdb.web.rest.errors.LoginAlreadyUsedException;
...
public class UserResource {
    ...
    public ResponseEntity<List<UserDTO>> getAllUsers(Pageable pageable) {
        final Page<UserDTO> page = userService.findAllManagedUsers(pageable);
    ...
    public ResponseEntity<UserDTO> getUser(@PathVariable String login) {
        ...
        return ResponseUtil.wrapOrNotFound(
            userService.findUserWithRolesByLogin(login)
                .map(UserDTO::new));
    }
   ...
   // @PreAuthorize("hasAuthority(\"" + AuthoritiesConstants.ADMIN + "\")")
    public ResponseEntity<Void> deleteUser(@PathVariable String login) {
        ...
        userService.deteteUserByLogin(login);
